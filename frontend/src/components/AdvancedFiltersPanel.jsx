 ...
 *
 * Controlled collapse via the `isOpen` prop.
 * Uses a max-height CSS transition for a smooth expand/collapse.
 * Filter values are NEVER reset when the panel closes.
 */
const AdvancedFiltersPanel = ({ isOpen }) => {
